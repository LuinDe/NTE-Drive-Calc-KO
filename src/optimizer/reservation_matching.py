    ...
    *,
    ...
    if current_shapes is not None or drive_shapes is not None or reservation_shapes is not None:
        if (
            ...
            raise ValueError("드라이브 유형별 공동 매칭의 형태 인덱스가 일치하지 않습니다")
