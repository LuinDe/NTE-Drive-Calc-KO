...
class MainWindowNavigationMixin:
    def _build_ui(self):
        ...
        self.topbar_catalog_return = QPushButton("‹ 도구로 돌아가기", tbar)
        ...
        self.topbar_source_label = QLabel("점수 기준은 위챗 미니 프로그램 “이환 공방”에서 가져왔습니다")
