...
def _rules_wushoutieyu(selected: Any, rule_factory: type[Any]) -> tuple[Any, ...]:
    ...
    return (
        _make_rule(
            ...
            target_name="焰魂狂飙: Q 후 E/Q 피해 증가",
            target_scope="self",
...
def _rules_door(selected: Any, rule_factory: type[Any]) -> tuple[Any, ...]:
    ...
    return (
        _make_rule(
            ...
            target_name="错误的门: 자신 령속성 이능력 피해 증강",
            target_scope="self",
        ...
        _make_rule(
            ...
            target_name="错误的门: 다른 팀원 통용 피해 증가",
