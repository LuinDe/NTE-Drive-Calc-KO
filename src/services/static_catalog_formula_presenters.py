...
_EVIDENCE_LABELS = {
    "project_contract": "프로젝트 규칙",
    "implementation": "현재 구현",
    "public_behavior_test": "공개 동작 테스트",
    "official_static": "공식 정적 입력",
    "repository_audit": "저장소 감사",
}
_BOUNDARY_LABELS = {
    "project_rule": "프로젝트 규칙",
    "official_static_input": "공식 정적 입력",
    "runtime_derived": "런타임 파생",
    "observed_runtime": "런타임 관측",
}
...
def build_counterfactual_model_matrix(
    ...
    return CounterfactualMatrixView(
        ...
        readonly_notice=(
            "상태는 현재 근거와 소비자 커버리지만 설명하며, C++·Python 또는 프로덕션 반사실 계산을 제어하지 않습니다."
        ),
        status_counts=tuple(
