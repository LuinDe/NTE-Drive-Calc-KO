...
QWidget{color:#c9d1d9;font-family:"Malgun Gothic","Microsoft YaHei UI","Segoe UI",sans-serif;font-size:13px}
...
STANDARD_BUTTON_TEXT = {
    _standard_button_value(QDialogButtonBox.Ok): "확인",
    _standard_button_value(QDialogButtonBox.Cancel): "취소",
    _standard_button_value(QDialogButtonBox.Save): "저장",
    _standard_button_value(QDialogButtonBox.Close): "닫기",
    _standard_button_value(QDialogButtonBox.Yes): "예",
    _standard_button_value(QDialogButtonBox.No): "아니요",
    _standard_button_value(QDialogButtonBox.Discard): "버리기",
    _standard_button_value(QDialogButtonBox.Apply): "적용",
    _standard_button_value(QDialogButtonBox.Reset): "초기화",
    _standard_button_value(QDialogButtonBox.Open): "열기",
}
